...
public class GenericEngineTest
{
    ...
    {
        // Arrange
        const string DESC = "Prompt description";
        const string DESC_PRE = "/*";
        const string DESC_POST = "*/";
        const string TEXT_BLOCK_SEP = "\n\n";
        const string INPUT_PRE = "/*";
        const string INPUT_POST = "*/";
        const string OUTPUT_PRE = "[";
        const string OUTPUT_POST = "]";
        const string IN_OUT_SEP = "\n";
        const string EX_IN_1 = "input 1";
        const string EX_OUT_1 = "output 1";
        const string EX_IN_2 = "input 2";
        const string EX_OUT_2 = "output2";
        const string RESET_SEP = "reset";
    ...
    [Fact]
    public void ItHandlesSpecialChars()
    {
        // Arrange
