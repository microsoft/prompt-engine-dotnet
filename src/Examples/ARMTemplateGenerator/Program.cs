    ...
    static void Main(string[] args)
    {
        ...
        var settings = new Settings
        {
            ...
            Examples = new[]
            {
                new Interaction
                {
                    Input = "Create an empty template", Output = JsonFileMinimized("examples_basic.json")
                },
                new Interaction
                {
                    Input = "Add some storage", Output = JsonFileMinimized("examples_storage.json")
                },
                new Interaction
                {
                ...
                new Interaction
                {
                    Input = "Add a Ubuntu VM", Output = JsonFileMinimized("examples_ubuntuvm.json")
                }
            }
        };
